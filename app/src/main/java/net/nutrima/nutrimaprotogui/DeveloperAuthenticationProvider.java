...
import net.nutrima.client.AmazonCognitoSampleDeveloperAuthenticationClient;
import net.nutrima.client.GetTokenResponse;
import net.nutrima.client.LoginCredentials;
 ...
 */
public class DeveloperAuthenticationProvider extends AWSAbstractCognitoIdentityProvider {
